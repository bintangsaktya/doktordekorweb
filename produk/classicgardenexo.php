<!DOCTYPE html>
<html>
<title>DRDECOR - Classic Garden</title>
<meta charset="UTF-8">
...
<div class="w3-main w3-white" style="margin-left:260px">
  ...
  <div class="w3-container" id="apartment">
    <h2 class="w3-text-green">Classic Garden</h2>
    <div class="w3-display-container mySlides">
    <img src="../image/roy2.png" style="width:100%;margin-bottom:-6px">
  ...
  <div class="w3-container">
    ...
    <div class="w3-row w3-large">
      <div class="w3-col s6">
        ...
        <p><i class="fa fa-fw fa-check"></i> 5 Buah rangkaian bunga</p>
      </div>
      <div class="w3-col s6">
    ...
    <p>Tema Classic Garden ini menggambarkan kondisi ciri khas jawa yang dominan berbahan kayu. Tema ini memiliki filosofi seperti keadaan masa kerajaan Mataram, tema ini cocok digunakan untuk tema acara pernikahan.</p>
