<!DOCTYPE html>
<html>
<title>DRDECOR - Gedung Sasana Budaya UM Malang</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-light-grey w3-collapse w3-top" style="z-index:3;width:260px" id="mySidebar">
  <div class="w3-container w3-display-container w3-padding-16">
    ...
    <h3>Mulai dari Rp2.500.000/4jam;</h3>
    <h6>Provider : Bisnis UM</h6>
    <hr>
    <form action="../payment/payment106.php" target="_blank">
...
<div class="w3-main w3-white" style="margin-left:260px">
  ...
  <div class="w3-container" id="apartment">
    <h2 class="w3-text-green">Gedung Aula Sasana Budaya UM</h2>
    <div class="w3-display-container mySlides">
    <img src="../img/content/sasanabudaya.jpg" style="width:100%;margin-bottom:-6px">
  ...
  <div class="w3-container">
    ...
    <div class="w3-row w3-large">
      <div class="w3-col s6">
        ...
        <p><i class="fa fa-fw fa-tv"></i> 2 LCD Projector</p>
    ...
    <p>Untuk kursi, bisa disesuaikan dengan konfirmasi.</p>
  ...
  <div class="w3-container" id="contact">
    <h2>Contact</h2>
    <i class="fa fa-map-marker" style="width:30px"></i>Jl. Semarang No.5, Sumbersari, Kec. Lowokwaru, Kota Malang, Jawa Timur 65145<br>
