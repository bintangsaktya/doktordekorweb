<!DOCTYPE html>
<html>
<title>DRDECOR - Unggul Malang</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-light-grey w3-collapse w3-top" style="z-index:3;width:260px" id="mySidebar">
  <div class="w3-container w3-display-container w3-padding-16">
    ...
    <h3>Mulai dari Rp7.500.000;</h3>
    <h6>Provider : Unggul Malang</h6>
    <hr>
    <form action="../payment/payment103.php" target="_blank">
...
<div class="w3-main w3-white" style="margin-left:260px">
  ...
  <div class="w3-container" id="apartment">
    <h2 class="w3-text-green">Gedung Unggul Malang</h2>
    <div class="w3-display-container mySlides">
    <img src="../img/content/ungg.jpg" style="width:100%;margin-bottom:-6px">
  ...
  <div class="w3-container" id="contact">
    <h2>Contact</h2>
    <i class="fa fa-map-marker" style="width:30px"></i>Jl. Raya Karanglo, Karanglo, Banjararum, Kec. Singosari, Malang, Jawa Timur 65153<br>
