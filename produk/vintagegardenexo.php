<!DOCTYPE html>
<html>
<title>DRDECOR - Vintage Garden</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-light-grey w3-collapse w3-top" style="z-index:3;width:260px" id="mySidebar">
  <div class="w3-container w3-display-container w3-padding-16">
    ...
    <h3>Dekorasi</h3>
    <h3>Mulai dari Rp2500.000</h3>
    <h6>Provider : Exotica Florist Malang</h6>
    <hr>
    <form action="bettersoon.php" target="_blank">
...
<div class="w3-main w3-white" style="margin-left:260px">
  ...
  <div class="w3-container" id="apartment">
    <h2 class="w3-text-green">Vintage Garden</h2>
    <div class="w3-display-container mySlides">
    <img src="../image/roy1.png" style="width:100%;margin-bottom:-6px">
  ...
  <div class="w3-container">
    ...
    <div class="w3-row w3-large">
      <div class="w3-col s6">
        ...
        <p><i class="fa fa-fw fa-tv"></i> LED 56"</p>
      </div>
      <div class="w3-col s6">
    ...
    <p>Tema Vintage Garden cocok untuk pernikahan, namun tidak hanya untuk pernikahan saja, dalam acara pertemuan, event tahunan ataupun acara lainnya pun cocok untuk diterapkan, Dengan ciri khas vintage dan taman outdoor bukam berati tema ini hanya digunakan untuk event outdoor saja, untuk event indoor pun cocok untuk diterapkan</p>
