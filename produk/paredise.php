<!DOCTYPE html>
<html>
<title>DRDECOR - Paredise Castle</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-light-grey w3-collapse w3-top" style="z-index:3;width:260px" id="mySidebar">
  <div class="w3-container w3-display-container w3-padding-16">
    ...
    <h3>Dekorasi</h3>
    <h3>Mulai dari Rp3.200.000</h3>
    <h6>Provider : Exotica Florist Malang</h6>
    <hr>
    <form action="../payment/payment102.php" target="_blank">
...
<div class="w3-main w3-white" style="margin-left:260px">
  ...
  <div class="w3-container" id="apartment">
    <h2 class="w3-text-green">Paredise Castle</h2>
    <div class="w3-display-container mySlides">
    <img src="../image/roy4.png" style="width:100%;margin-bottom:-6px">
  ...
  <div class="w3-container">
    ...
    <div class="w3-row w3-large">
      <div class="w3-col s6">
        ...
        <p><i class="fa fa-fw fa-check"></i> 9 Buah Kursi Pengunjung(optional)</p>
    ...
    <p> Produk ini adalah paket pemesanan auditorium beserta dekorasinya, Untuk alamat gedung di Utara Splindid Malang</p>
