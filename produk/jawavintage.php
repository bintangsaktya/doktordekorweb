<!DOCTYPE html>
<html>
<title>DRDECOR - Jawa Vintage</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-light-grey w3-collapse w3-top" style="z-index:3;width:260px" id="mySidebar">
  <div class="w3-container w3-display-container w3-padding-16">
    ...
    <h3>Dekorasi</h3>
    <h3>Mulai dari Rp4500.000</h3>
    <h6>Provider : Podomoro Malang</h6>
    <hr>
    <form action="../payment/payment98.php" target="_blank">
...
<div class="w3-main w3-white" style="margin-left:260px">
  ...
  <div class="w3-container" id="apartment">
    <h2 class="w3-text-green">Jawa Vintage</h2>
    <div class="w3-display-container mySlides">
    <img src="../image/idk2.jpg" style="width:100%;margin-bottom:-6px">
  ...
  <div class="w3-container">
    ...
    <div class="w3-row w3-large">
      <div class="w3-col s6">
        ...
        <p><i class="fa fa-fw fa-check"></i> 30 Buah Kursi Pengunjung(optional)</p>
        <p><i class="fa fa-fw fa-check"></i> 8 Buah rangkaian bunga</p>
      </div>
      <div class="w3-col s6">
    ...
    <p>Menggambarkan suasana jawa, kerajaan jawa tengahan serta perpaduan antara kultur nusantara dengan barat</p>
