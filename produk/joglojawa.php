<!DOCTYPE html>
<html>
<title>DRDECOR - Joglo Jawa</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-light-grey w3-collapse w3-top" style="z-index:3;width:260px" id="mySidebar">
  <div class="w3-container w3-display-container w3-padding-16">
    ...
    <h3>Dekorasi</h3>
    <h3>Mulai dari Rp5.500.000</h3>
    <h6>Provider : Podomoro Malang</h6>
    <hr>
    <form action="../payment/payment100.php" target="_blank">
...
<div class="w3-main w3-white" style="margin-left:260px">
  ...
  <div class="w3-container" id="apartment">
    <h2 class="w3-text-green">Joglo Jawa</h2>
    <div class="w3-display-container mySlides">
    <img src="../image/idk1.jpg" style="width:100%;margin-bottom:-6px">
  ...
  <div class="w3-container">
    ...
    <p>Menggambarkan suasana jawa, kerajaan jawa tengahan</p>
